# Defer with unevaluated arguments

**Category:** defer-traps
**Agent ID:** `unevaluated-args`

## What this agent looks for

Finds deferred calls whose arguments are evaluated at defer-time in a way that captures a stale value.
