# Nil-channel block detector

**Category:** channels
**Agent ID:** `nil-channel-block`

## What this agent looks for

Finds sends/receives on channels that can be nil at runtime, which block forever instead of erroring.
