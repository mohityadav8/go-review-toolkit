# Nil-pointer-satisfies-interface footgun

**Category:** interfaces
**Agent ID:** `nil-pointer-satisfies`

## What this agent looks for

Flags methods with pointer receivers on types whose nil value is returned as satisfying an interface.
